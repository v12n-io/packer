...
echo "growpart /dev/sda 3 > /dev/null 2>&1" >> /etc/rc.local
echo "pvresize /dev/sda4 > /dev/null 2>&1" >> /etc/rc.local
echo "lvextend -l +100%FREE -r /dev/mapper/sysvg-lvroot > resize.txt 2>&1" >> /etc/rc.local
