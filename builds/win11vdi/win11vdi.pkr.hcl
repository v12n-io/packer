...
build {
    ...
    provisioner "powershell" {
        ...
        inline                  = [ "powercfg.exe /setactive 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c",
                                    ...
                                    "Get-AppxPackage *AV1VideoExtension* -AllUsers | Remove-AppxPackage",
                                    ...
                                    "Get-AppxPackage *HEIFImageExtension* -AllUsers | Remove-AppxPackage",
                                    "Get-AppxPackage *GetHelp* -AllUsers | Remove-AppxPackage",
                                    "Get-AppxPackage *WindowsMaps* -AllUsers | Remove-AppxPackage",
                                    "Get-AppxPackage *MicrosoftEdge* -AllUsers | Remove-AppxPackage",
                                    "Get-AppxPackage *Todos* -AllUsers | Remove-AppxPackage",
                                    ...
                                    "Get-AppxPackage *OneDriveSync* -AllUsers | Remove-AppxPackage",
                                    "Get-AppxPackage *People* -AllUsers | Remove-AppxPackage",
                                    "Get-AppxPackage *Windows.Photos* -AllUsers | Remove-AppxPackage",
                                    "Get-AppxPackage *PowerAutomateDesktop* -AllUsers | Remove-AppxPackage",
                                    ...
                                    "Get-AppxPackage *MicrosoftStickyNotes* -AllUsers | Remove-AppxPackage",
                                    ...
                                    "Get-AppxPackage *WebpImageExtension* -AllUsers | Remove-AppxPackage",
